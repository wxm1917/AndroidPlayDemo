package com.rename.qiyuan.main.util;
...
public class PermissionUtils {
     ...
     */
    public static void checkAndRequestPermissions(List<String> permissionList, Activity activity) {
        ...
        //正式请求权限
        ActivityCompat.requestPermissions(activity, permissions, PermissionUtils.MY_PERMISSIONS_REQUEST);
